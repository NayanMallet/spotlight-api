...
const GetEventMembersController = () => import('#events/controllers/get_event_members_controller')
// endregion
...
router
  .group(() => {
    ...
    router.get('/events/:id/members', [GetEventMembersController]).as('events.members')
